<template>
  <div class="catalog">
    ...
    <ItemsList type="catalog" class="right__list" :items="itemsStore.tf" />
  </div>
</template>
...
onMounted(() => {
  selectedGameStore.updateSelectedGame(selectedGameStore.games[3], router);
  fetchData();
});
</script>
