<template>
  <div class="catalog">
    ...
    <ItemsList type="catalog" class="right__list" :items="itemsStore.dota" />
  </div>
</template>
...
onMounted(() => {
  selectedGameStore.updateSelectedGame(selectedGameStore.games[1], router);
  fetchData();
});
</script>
