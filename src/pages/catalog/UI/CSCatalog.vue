<template>
  <div class="catalog">
    ...
    <ItemsList type="catalog" class="right__list" :items="itemsStore.cs" />
  </div>
</template>
...
onMounted(() => {
  selectedGameStore.updateSelectedGame(selectedGameStore.games[0], router);
  // fetchData();
});
</script>
